...
```
#Plot AT4G21910
ggRNA(tx_id="AT4G21910.1",Y_scale = "each",NAME="MATE efflux family protein",Extend=c(700,0))
```
...
```
#Plot AT4G21910
ggRNA(tx_id="AT4G21910.1",Y_scale = "all",NAME="MATE efflux family protein",Extend=c(700,0))
```
...
```
#Plot AT4G21910
ggRNA(tx_id="AT4G21910.1",Y_scale = "all",NAME="MATE efflux family protein",Extend=c(700,0),RNAbackground = c("lightblue","lightgreen","yellow","red"))
```
...
```
#Plot AT4G21910
ggRNA(tx_id="AT4G21910.1",Y_scale = "all",NAME="MATE efflux family protein",Extend=c(800,0),RNAbackground = c("lightblue","lightgreen","yellow","red"),RNAcoverline = NA)
```
