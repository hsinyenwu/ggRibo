...
#Install ggRibo
library(devtools)
install_github("hsinyenwu/ggRibo@v2026.02.25")
```
...
**!!! For Windows, if you need to load human or other large genomes, please use BSgenome object instead of FASTA file when loading the DNA sequences.**   
