...
It is nearly impossible to check which transcript(s) is translated with the single transcript style plot. The isoform 3 is not transcribed in the sample and leads to a confusing plot.
